"""
Django settings for Sistema OS project.
...
SHARED_APPS = [
    ...
    'apps.core',
    'apps.accounts',
    'apps.forum',  # Fórum é compartilhado (schema público)
]

TENANT_APPS = [
    # Tenant-specific apps (cada tenant tem seu próprio schema)
    'apps.erp',
    'apps.estoque',
    'apps.compras',
    'apps.vendas',
...
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgresql://postgres:postgres@localhost:5432/sistemaos'),
        conn_max_age=600,
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API completa para sistema ERP de assistência técnica',
    'VERSION': '1.0.0',
